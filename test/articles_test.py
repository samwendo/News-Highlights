...
#         '''
#         self.new_article = Articles('CNN', 'Peter Pollen', 'The tech scene in Africa-Is it the next big thing?', 'A look at various tech hubs in Africa and the impact they have on the worlds economy', 'techie.com', 'techie.com/7643t94.jpg', '2018-04-11T07:57:16Z')
...
#         self.assertEquals(self.new_article.author, 'Peter Pollen')
